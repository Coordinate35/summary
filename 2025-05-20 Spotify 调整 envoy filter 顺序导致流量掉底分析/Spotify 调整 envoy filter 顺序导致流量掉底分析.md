...
### 容量风险的特点
1. 接入层通常扮演限流器的角色，保护业务服务。但是, 却没人能保护他
2. 外网故障的发生。很可能不在上班时期。
...
6. 公网带宽. 虽然基础网络设备通常由网络组的同学维护，但是网络的同学只能切 bgp，通常还需要接入层SRE、业务 SRE 同步配合通过 DNS 切换进行止损. 公网带宽通常也比较贵，不舍得花钱。
...
3. 双活切流。
4. 扩容。
5. 自保拒绝流量。被拒绝的流量仍然会消耗至少原本处理这个请求所需要的 1/4 的计算资源
6. 网络带宽：
   1. 接入高防包、流量清洗
   2. 流量黑洞。前提是域名有拆分。通常流量符合 2/8 原则. 将不重要的流量通过 DNS 进行黑洞，保全核心流量.
   3. 自愈能力的建设。
